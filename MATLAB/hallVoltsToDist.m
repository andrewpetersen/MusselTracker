...
function distances = hallVoltsToDist(hallDigitalVoltages, zeroPoint)
...
tareDistance = modelFun(coefEsts,zeroPoint);
distances=modelFun(coefEsts,hallDigitalVoltages) - tareDistance;
